...
class InterviewController extends StateNotifier<InterviewState> {
  ...
  InterviewContext buildContext({InterviewType? type, Job? job}) {
    ...
    return InterviewContext(
      ...
      // Default the interview market to Qatar (the app's home market), independent
      // of the persisted profile country — consistent with Browse / Matching / Coach.
      country: CountriesData.defaultCountry.name,
    );
  }
