...
/// `printing` supplying preview/share upstream. Maps each implemented
/// [CvTemplateId] to a [PdfTemplate]; "coming soon" ids throw
/// [CvErrorCode.templateUnavailable].
class PdfCvGenerator implements CvPdfGenerator {
  PdfCvGenerator({CvFonts? fonts, Map<CvTemplateId, PdfTemplate>? templates})
      : _injectedFonts = fonts,
        _templates = templates ?? const {CvTemplateId.ats: AtsTemplate()};
